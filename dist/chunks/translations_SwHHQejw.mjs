...
import { A as AstroError, U as UnknownContentCollectionError, c as createComponent, R as RenderUndefinedEntryError, u as unescapeHTML, b as renderTemplate, p as renderUniqueStylesheet, q as renderScriptElement, t as createHeadAndContent, r as renderComponent, a as AstroUserError } from './astro/server_DVAIC14D.mjs';
import 'piccolore';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_Cqm5S2Lr.mjs');
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_PsMGt394.mjs').then(n => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_DmiS8zJQ.mjs');
...
const starlightConfig = {"logo":{"dark":"/src/assets/logo-dark.svg","light":"/src/assets/logo-light.svg","alt":"DocKit Logo","replacesTitle":false},"social":[{"icon":"seti:favicon","label":"About Me","href":"https://im1010ioio.dev"},{"icon":"codePen","label":"CodePen","href":"https://codepen.io/collection/mrMvMk"},{"icon":"linkedin","label":"LinkedIn","href":"https://www.linkedin.com/in/im1010ioio"},{"icon":"instagram","label":"Instagram","href":"https://www.instagram.com/im1010ioio"},{"icon":"email","label":"Email","href":"mailto:dev@im1010ioio.dev?body=Hello, Yi Lin,"}],"tableOfContents":{"minHeadingLevel":2,"maxHeadingLevel":3},"editLink":{},"sidebar":[{"label":"[pencil] 前言","translations":{},"collapsed":false,"autogenerate":{"directory":"preface","attrs":{}}},{"label":"[document] 基礎知識 / 共用觀念","translations":{},"collapsed":false,"autogenerate":{"directory":"basics","attrs":{}}},{"label":"[seti:csv] 版面編排","translations":{},"collapsed":false,"autogenerate":{"directory":"layout","attrs":{}}},{"label":"[laptop] 響應式 RWD","translations":{},"collapsed":false,"autogenerate":{"directory":"rwd","attrs":{}}},{"label":"[translate] 文字","translations":{},"collapsed":false,"autogenerate":{"directory":"text","attrs":{}}},{"label":"[seti:elixir] 顏色","translations":{},"collapsed":false,"autogenerate":{"directory":"color","attrs":{}}},{"label":"[seti:image] 多媒體","translations":{},"collapsed":false,"autogenerate":{"directory":"multimedia","attrs":{}}},{"label":"[seti:svg] 繪製漸層與圖形","translations":{},"collapsed":false,"autogenerate":{"directory":"gradients-shapes","attrs":{}}},{"label":"特效","translations":{},"collapsed":false,"autogenerate":{"directory":"effects","attrs":{}}},{"label":"互動 - Transition","translations":{},"collapsed":false,"autogenerate":{"directory":"interaction-transition","attrs":{}}},{"label":"互動 - Animation","translations":{},"collapsed":false,"autogenerate":{"directory":"interaction-animation","attrs":{}}},{"label":"互動 - click toggle 行為","translations":{},"collapsed":false,"autogenerate":{"directory":"interaction-click","attrs":{}}},{"label":"互動 - scroll 行為","translations":{},"collapsed":false,"autogenerate":{"directory":"interaction-scroll","attrs":{}}},{"label":"[seti:sass] Sass/SCSS","translations":{},"collapsed":false,"autogenerate":{"directory":"sass-scss","attrs":{}}},{"label":"CSS 框架初探","translations":{},"collapsed":false,"autogenerate":{"directory":"css-frameworks","attrs":{}}},{"label":"[magnifier] SEO 與其他實用工具","translations":{},"collapsed":false,"autogenerate":{"directory":"seo-tools","attrs":{}}},{"label":"[pencil] 雜記","translations":{},"collapsed":false,"autogenerate":{"directory":"misc","attrs":{}}}],"head":[],"lastUpdated":false,"pagination":true,"favicon":{"href":"/favicon.ico","type":"image/x-icon"},"titleDelimiter":"|","credits":false,"title":{"zh-TW":"超級簡單寫 CSS (Super Easy CSS)"},"isMultilingual":true,"defaultLocale":{"label":"繁體中文","lang":"zh-TW","dir":"ltr"},"locales":{"root":{"label":"繁體中文","lang":"zh-TW","dir":"ltr"},"en":{"label":"English","lang":"en","dir":"ltr"}}};

const project = {"build":{"format":"directory"},"root":"file:///Users/chenyilin/Documents/GitHub/super-easy-css-blog/","srcDir":"file:///Users/chenyilin/Documents/GitHub/super-easy-css-blog/src/","trailingSlash":"ignore"};
...
export { BuiltInDefaultLocale as B, DEFAULT_HASH_PROPS as D, VALID_SUPPORTED_FORMATS as V, stripLeadingAndTrailingSlashes as a, stripTrailingSlash as b, createTranslationSystem as c, getEntry as d, stripLeadingSlash as e, stripHTMLExtension as f, getCollectionUrl as g, ensureHTMLExtension as h, ensureTrailingSlash as i, project as j, getCollection as k, getCollectionPathFromRoot as l, pickLang as m, ensureLeadingSlash as n, stripExtension as o, processI18nConfig as p, DEFAULT_OUTPUT_FORMAT as q, renderEntry as r, starlightConfig as s, useTranslations as u };
